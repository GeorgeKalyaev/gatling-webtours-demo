# Сценарий WebTours (Gatling)

**[← К документации](../../README.md)** · **[English version](../en/01-webtours-scenario.md)**
...
См. также: **[Описание составляющей части проекта (Gatling)](03-gatling-project-structure.md)** (каталоги `resources` / `scala`, паттерн `Action` / `Scenario` / `Feeder`).
...
![Fiddler: JSON с двумя позициями в items](../images/fiddler-json-two-items.png)

**Пять элементов в `items` (максимум в скрипте):**

![Fiddler: JSON с пятью позициями в items](../images/fiddler-json-five-items.png)
