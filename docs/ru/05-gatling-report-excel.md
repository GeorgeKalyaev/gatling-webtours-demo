...
8. На листе **Errors** отображается **статистика по ошибкам за весь тест**: колонки **Error Code**, **Group**, **Endpoint**, **Count** — код/тип ошибки из лога, группа сценария Gatling, эндпоинт и число срабатываний. Второй лист **Requests per min** — агрегаты успешных запросов по минутам (см. описание колонок выше).
